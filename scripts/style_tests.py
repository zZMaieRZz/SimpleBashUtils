...
def get_source_filenames(arr_of_files=None, depth=0, path=PATH_TO_PROJECT):
...
def copy_config():
    subprocess.run(['cp', PATH_TO_PROJECT + '/scripts/.clang-format', PATH_TO_PROJECT], stdout=devnull_stdout,
